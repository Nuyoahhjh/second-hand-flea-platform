	...
	export default {
		data() {
			return {
				bottomData: [{
						text: '微信',
						icon: 'https://ithejunhao-1312274892.cos.ap-chongqing.myqcloud.com/tiaozao/shop/weixin.png',
						name: 'wx'
					},
					{
						text: '朋友圈',
						icon: 'https://ithejunhao-1312274892.cos.ap-chongqing.myqcloud.com/tiaozao/shop/pengyouquan.png',
						name: 'copy'
					},
					{
						text: 'QQ',
						icon: 'https://ithejunhao-1312274892.cos.ap-chongqing.myqcloud.com/tiaozao/shop/qq.png',
						name: 'qq'
					},
					{
						text: '复制',
						icon: 'https://ithejunhao-1312274892.cos.ap-chongqing.myqcloud.com/tiaozao/shop/copy.png',
						name: 'copy'
					}
				],
				// sharedataTemp: {
